...
const STAGE_STATUS_CLR: Record<string, string> = { complete: '#22c55e', active: '#1d4ed8', pending: `${getColor(25)}` };
...
export default function PipelineCard({ data, accentColor, onAction }: TeleComponentProps) {
    const { title, stages = [] } = data as PipelineCardData;
